...
class test_react1_models:
    ...
    def test0(model, test0_mode):
        ...
        if test0_mode == 0:
            ...
            nodes = ['P2', 'F7', 'V6', 'F_sc', 'L_sp', 'T_reg', 'P6', 'V3']
            dummy_nodes_struct = []
            edges = [('V6', 'P2') , ('V6', 'F7') , ('F7', 'P2') , ('F7', 'T_reg') , ('P2', 'T_reg') , ('V3', 'F_sc') , ('F_sc', 'L_sp') , ('F_sc', 'T_reg')]
            ...
            nodes = ['P2', 'F7', 'V6', 'F_sc', 'L_sp', 'T_reg', 'P6', 'V3']
            dummy_nodes_struct = []
            edges = [('V6', 'P2') , ('V6', 'F7') , ('F7', 'P2') , ('F_sc', 'T_reg') , ('V3', 'F_sc')]
    ...
    # Test 2: Unit interactions
    def test2(model, test2_mode):

        if test2_mode == 0:

            nodes = ['T_reg', 'L_sp', 'P6', 'V7', 'T_cyc', 'C_co', 'C_o2', 'F_rgc', 'V2', 'F_sg']
            dummy_nodes_struct = []
            edges = [('T_reg', 'C_co') , ('T_reg', 'C_o2') , ('T_reg', 'T_cyc') , ('V7', 'F_sg') , ('V7', 'T_cyc') , ('V2', 'F_rgc') , ('F_rgc', 'L_sp')]

        elif test2_mode == 1:

            nodes = ['T_reg', 'L_sp', 'P6', 'V7', 'T_cyc', 'C_co', 'C_o2', 'F_rgc', 'V2', 'F_sg']
            dummy_nodes_struct = []
            edges = [('T_reg', 'C_co') , ('T_reg', 'C_o2') , ('T_reg', 'T_cyc') , ('V7', 'F_sg') , ('F_sg', 'T_cyc') , ('V2', 'F_rgc') , ('F_rgc', 'L_sp')]

        elif test2_mode == 2:

            nodes = ['T_reg', 'L_sp', 'P6', 'V7', 'T_cyc', 'C_co', 'C_o2', 'F_rgc', 'V2', 'F_sg']
            dummy_nodes_struct = []
            edges = [('T_reg', 'T_cyc') , ('V7', 'F_sg') , ('V7', 'T_cyc') , ('V2', 'F_rgc') , ('F_rgc', 'L_sp')]

        elif test2_mode == 3:

            nodes = ['T_reg', 'L_sp', 'P6', 'V7', 'T_cyc', 'C_co', 'C_o2', 'F_rgc', 'V2', 'F_sg']
            dummy_nodes_struct = []
            edges = [('T_reg', 'T_cyc') , ('V7', 'F_sg') , ('F_sg', 'T_cyc') , ('V2', 'F_rgc') , ('F_rgc', 'L_sp')]

        elif test2_mode == 4:

            nodes = ['T_reg', 'L_sp', 'P6', 'V7', 'T_cyc', 'C_co', 'C_o2', 'F_rgc', 'V2', 'F_sg']
            dummy_nodes_struct = []
            edges = [('V7', 'F_sg') , ('V7', 'T_cyc') , ('V2', 'F_rgc')]

        elif test2_mode == 5:

            nodes = ['T_reg', 'L_sp', 'P6', 'V7', 'T_cyc', 'C_co', 'C_o2', 'F_rgc', 'V2', 'F_sg']
            dummy_nodes_struct = []
            edges = [('V7', 'F_sg') , ('F_sg', 'T_cyc') , ('V2', 'F_rgc')]
