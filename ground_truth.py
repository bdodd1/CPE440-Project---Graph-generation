...
nodes = ['F3', 'T1', 'P4', 'deltaP', 'P6', 'T3', 'T2', 'T_r', 'T_reg', 'L_sp', 'T_cyc', 'T_cyc-T_reg', 'X_co', 'X_o2', 'P5', 'V4', 'V6', 'V7', 'V3', 'V1', 'V2', 'F_rgc', 
...
# Regenerator
edges.extend([('F7', 'P6') , ('P2', 'P6') , ('F7', 'T_reg') , ('F_sc', 'T_reg') , ('F_sc', 'L_sp') , ('F_rgc', 'L_sp') , ('V3', 'F_sc') , ('V2', 'F_rgc') , ('T_reg', 'X_co') , ('P6', 'X_co') , ('T_reg', 'X_o2') , ('P6', 'X_o2') , ('V7', 'T_cyc'),
...
plt.xticks(range(len(nodes)), nodes, rotation='vertical')
